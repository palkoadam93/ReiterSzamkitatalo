    ...
    class Program
    {
        ...
        PLAYER:
            ...
            while (i < 5)
            {
                ...
                switch(Console.ReadKey(true).KeyChar)
                {
                    case 'k': if (i == 3) x = r.Next(min, x); else { max = x; x -= (max - min) / 2; } break;
                    case 'n': if (i == 3) x = r.Next(x + 1, max); else { min = x; x += (max - min) / 2; } break;
                    case 'e': Console.WriteLine("A számítógép nyert!"); goto END;
                }
                ++i;
            }
        ...
        COMPUTER:
            ...
            while (i < 5)
            {
                ...
                if (x < number) Console.WriteLine("A szám ennél nagyobb!");
                else if (x > number) Console.WriteLine("A szám ennél kisebb!");
                else { Console.WriteLine("Nyertél!"); goto END; }
                ++i;
            }
